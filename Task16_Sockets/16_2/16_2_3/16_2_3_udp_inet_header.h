...
static const char k_MSG_T_INIT_ME = '2';

static const char *const k_msg_client_init = "INIT_ME";
static const char *const k_msg_client_init_ok = "INIT_OK";

static const char *const k_message_queue_name = "/16_2_2_UDP_INET_SERVER";
static const char *const k_template_i_am_free = "FREE";

static const char *const k_server_ip = "127.0.0.1";

static const char *const k_server_types_str[3]
    = { "MAIN SERV", "_SUB SERV", "___CLIENT" };
typedef enum
{
  SERV_T_MAIN_SERV = 0,
  SERV_T_SUB_SERV,
